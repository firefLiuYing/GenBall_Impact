...
namespace Yueyn.Pool
{
    /// <summary>
    /// 对象池管理器（新体系基建）
    /// 照搬 ObjectPoolManager 的实现，但去掉 IComponent 接口
    /// </summary>
    public sealed partial class CPoolManager : Singleton<CPoolManager>
    {
        ...
        private readonly Dictionary<TypeNamePair, ObjectPoolBase> _objectPools = new Dictionary<TypeNamePair, ObjectPoolBase>();
        private readonly List<ObjectPoolBase> _cachedAllObjectPools = new List<ObjectPoolBase>();
        ...
        /// <summary>
        /// 更新所有对象池（需要在 FrameworkBase 中手动调用）
        /// </summary>
